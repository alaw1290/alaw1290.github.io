...
function showSection(section) {
	...
	section.getElementById("id").add('active');
	// section.nextElementSibling.style.display = "block";
	section.getElementById("content").style.display = "block";
};

function hideSection(section) {
	// section.classList.remove('active');
	section.getElementById("id").remove('active');
	// section.nextElementSibling.style.display = "none";
	section.getElementById("content").style.display = "none";
};
